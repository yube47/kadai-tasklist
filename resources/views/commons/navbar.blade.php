<header class="mb-4">
    <nav class="navbar bg-neutral text-neutral-content">
        ...
        <div class="flex-none">
            <ui tabindex="0" class="menu lg:block lg:menu-horizontal">
                {{--タスク作成へのリンク--}}
                <li><a class="link link-hober" href="{{route('task.create')}}">新規タスク作成</a></li>
            ...
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 text-info">
                    {{-- タスク作成ページへのリンク --}}
                    <li><a class="link link-hover" href="{{ route('task.create') }}">新規タスク作成</a></li>
                </ul>
            </div>
        </div>
    </nav>
